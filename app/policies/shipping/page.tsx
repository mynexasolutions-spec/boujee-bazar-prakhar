    ...
    <main className="overflow-x-hidden pt-[72px] md:pt-[84px] bg-white min-h-screen flex flex-col font-body">
      ...
      <div className="flex-1 max-w-3xl mx-auto w-full px-5 py-16 md:py-24">
        ...
        <div className="prose prose-neutral prose-sm md:prose-base text-neutral-600 max-w-none space-y-6">
          ...
          <h3 className="font-display font-semibold text-xl text-neutral-900 mt-8 mb-4">1. Processing Time</h3>
          <p>
            All standard orders are processed within 2-3 business days. Custom or personalized orders require an additional 5-7 business days for production before dispatch.
          </p>

          <h3 className="font-display font-semibold text-xl text-neutral-900 mt-8 mb-4">2. Shipping Timelines</h3>
          <p>
            We ship across Pan-India from our studio.
          </p>
          ...
          <h3 className="font-display font-semibold text-xl text-neutral-900 mt-8 mb-4">3. Shipping Charges</h3>
          <p>
            We offer free standard shipping on all orders above ₹1,499. For orders below this amount, a flat shipping fee of ₹99 applies.
          </p>

          <h3 className="font-display font-semibold text-xl text-neutral-900 mt-8 mb-4">4. Tracking Your Order</h3>
          <p>
